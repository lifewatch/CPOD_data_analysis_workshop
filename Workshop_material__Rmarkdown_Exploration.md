...
The file **hi\_mod.tab** contains the detections of quality hi and mod pooled together for each hour. We will use this file for this session.
...
```
    ...
    ##  Median :     0   Median :    0.00       Median : 59279     
...
```
    ...
    ##                    <fctr>      <dbl>      <dbl>   <dbl>
    ##  1  bnps-Reefballs-cpower          1 4.54763314     104
    ##  2       bpns-Belwind C05          0 0.53776042      23
    ##  3        bpns-Birkenfels          0 0.01369863       1
    ##  4         bpns-Lottobuoy          0 1.10952934      65
    ##  5     bpns-Oostdyck West          0 1.62466033      53
    ##  6 bpns-Reefballs Belwind          0 3.70415760      88
    ##  7              Gootebank          0 2.00121338      71
    ##  8            Middelkerke          0 1.97531372      96
    ##  9               Oostende          0 0.58160068      46
    ## 10                WK9en12          0 2.45527231     100
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-40-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-41-1.png)

``` r
ggplot() + geom_point(data = poddata_day, aes(x= Time, y = Quality))
```

![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-42-1.png)

``` r
ggplot(data = poddata_day) + geom_point(aes(x= Time, y = Quality))
```

![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-42-2.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-43-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-44-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-45-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-46-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-47-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-48-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-49-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-50-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-51-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-52-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-53-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-54-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-55-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-56-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-57-1.png)
...
![](Workshop_material__Rmarkdown_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-58-1.png)
